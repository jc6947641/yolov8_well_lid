...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    RTDETRDecoder, Segment, MV2Block, MobileViTBlock, EVCBlock, CBAM, CARAFE)
...
class BaseModel(nn.Module):
    ...
    def forward(self, x):
        ...
        if isinstance(x, dict):
            return self.loss(x)  # Removed *args and **kwargs
        return self.predict(x)  # Removed *args and **kwargs
